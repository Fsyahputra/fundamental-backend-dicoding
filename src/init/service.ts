...
const accessTokenSecret = process.env["ACCESS_TOKEN_KEY"] || "defaultAccessTokenKey";
const refreshTokenSecret = process.env["REFRESH_TOKEN_KEY"] || "defaultRefreshTokenKey";
...
const authService = new AuthService(accessTokenSecret, refreshTokenSecret, pool);
...
const musicCoordService = new MusicCoordService(playlistService, songService, playlistSongService);
